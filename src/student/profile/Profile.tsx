...
export const Profile = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-6 px-2 sm:px-4">
      <div className="max-w-5xl mx-auto bg-white shadow-lg rounded-2xl overflow-hidden flex flex-col sm:flex-row">
        {/* Lado izquierdo - avatar y nombre */}
        <div className="bg-purple-600 w-full sm:w-1/3 p-6 sm:p-8 flex flex-col items-center text-white">
          <img
